...
# SPDX-FileCopyrightText: 2016-present Jakub Jirutka <jakub@jirutka.cz>
#
...
: "${APK_TOOLS_URI:="https://gitlab.alpinelinux.org/api/v4/projects/5/packages/generic/v3.0.3/x86_64/apk.static"}"
: "${APK_TOOLS_SHA256:="55e75476ea36ccd0d0d1e83c8c4233cd47bf9cb2512e1ecc43c17e6dc60f91ee"}"
