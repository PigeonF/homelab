...
hl-vhost-x-01 $ systemd-cryptenroll /dev/nvme0n1p4 --fido2-device=auto --fido2-with-client-pin=false --fido2-with-user-presence=true --fido2-with-user-verification=false
