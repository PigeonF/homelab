...
[source,console]
----
$ SSHPASS=root nix run nixpkgs#nixos-anywhere -- --flake '.#hl-vhost-x-01' --target-host root@nixos-installer.fritz.box --env-password --generate-hardware-config nixos-facter ./facter.json
----
